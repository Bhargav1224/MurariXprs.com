...
export const IphoneStore = () => {
	...
	const Fetchiphonedata = () => {
		setLoading(true);
		return axios
			.get(`https://bhargavreddy1224.herokuapp.com/MurariProducts?type=iphone`)
			.then((res) => {
				setMenData(res.data);
				setIndData(res.data);
				setFilter(res.data);
	...
	const Sortdata = (e) => {
		...
		return axios
			.get(
				`https://bhargavreddy1224.herokuapp.com/MurariProducts?type=iphone&_sort=${name}&_order=${value}`
			)
			.then((res) => {
				setMenData(res.data);
			});
				...
				<div className={styles.sortcontainer}>
					<div className={styles.sorting}>
						<div className={styles.matter}>
							<h1>Feel the iPhone,No Its Your phone</h1>
							<h3>
