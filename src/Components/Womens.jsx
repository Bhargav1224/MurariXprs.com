...
export const Womens = () => {
	...
	const FetchWonendata = () => {
		setLoading(true);
		return axios
			.get(`https://bhargavreddy1224.herokuapp.com/MurariProducts?type=women`)
			.then((res) => {
	...
	const Sortdata = (e) => {
		...
		return axios
			.get(
				`https://bhargavreddy1224.herokuapp.com/MurariProducts?type=women&_sort=${name}&_order=${value}`
			)
			.then((res) => {
				setMenData(res.data);
			});
